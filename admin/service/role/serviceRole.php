            ...
            case "saveInfo":
                ...
                if (!empty($_POST['select_users']) && $_POST['select_users'] != "") {
                    ...
                    foreach ($select_users as $userid) {
                        $insert_str = "insert into t_User_Role_Set(id,userid,roleid) values('" . service\tools\common\UUIDClass::getUUID() . "','" . $userid . "','" . $roleid . "')";
                ...
                if (!empty($_POST['select_menus']) && $_POST['select_menus'] != "") {
                    ...
                    foreach ($select_menus as $menuid) {
                        $insert_str = "insert into t_Role_Menu_Set(id,roleid,menuid) values('" . service\tools\common\UUIDClass::getUUID() . "','" . $roleid . "','" . $menuid . "')";
                        $connection->addBatch($insert_str);
                    }
                }
                ...
                if (!empty($_POST['select_modulefuncs']) && $_POST['select_modulefuncs'] != "") {
                    ...
                    foreach ($select_modulefuncs as $modulefunc) {
                        if ($modulefunc['type'] == '0') {
                            $connection->addBatch("insert into t_Role_Module_Set(id,roleid,moduleid) values('" . service\tools\common\UUIDClass::getUUID() . "','" . $roleid . "','" . $modulefunc['id'] . "')");
                        } else {
                            $connection->addBatch("insert into t_Role_Module_Func_Set(id,roleid,funcid) values('" . service\tools\common\UUIDClass::getUUID() . "','" . $roleid . "','" . $modulefunc['id'] . "')");
                        }
                    }
                }
                if (!$connection->doExecBatch()) {
