...
$backService2 = array();
$backService2['httphostIn'] = $portalConfig['backService2']['httphostIn'];
$backService2['httptimeout'] = intval($portalConfig['backService2']['httptimeout']);
$backService2['charset'] = $portalConfig['backService2']['charset'];
$GLOBALS['backservice'] = $backService;
$GLOBALS['backservice2'] = $backService2;
