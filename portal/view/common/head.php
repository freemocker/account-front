...
if ($GLOBALS['alone_page']) {
    ...
    echo 'var G_backService = {httphostIn:"' . $GLOBALS['backService']['httphostIn'] . '",httptimeout:' . $GLOBALS['backService']['httptimeout'] . ',charset:"' . $GLOBALS['backService']['charset'] . '"};';
    echo 'var G_backService2 = {httphostIn:"' . $GLOBALS['backService2']['httphostIn'] . '",httptimeout:' . $GLOBALS['backService2']['httptimeout'] . ',charset:"' . $GLOBALS['backService2']['charset'] . '"};';
