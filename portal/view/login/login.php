    ...
    if (empty($_POST['username']) || trim($_POST['username']) == "") {
        ...
        if (empty($_POST['pen']) || trim($_POST['pen']) == "") {
            ...
            if (empty($_POST['yzm']) || trim($_POST['yzm']) == "") {
                ...
                $yzm = trim($_POST['yzm']);
                $login = new portal\service\login\LoginClass();
                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="white"
                                  id="id-text2"><?php echo $GLOBALS['application']->getAppname(); ?></span>
                        </h1>
                        <h4 class="light-blue"
                            id="id-company-text">&copy; <?php echo $GLOBALS['application']->getCopyrightOwner() . ' <small>(v' . $GLOBALS['application']->getVersion() . ')</small>'; ?></h4>
                    </div>
                                        ...
                                        <fieldset form="loginform">
                                            <label class="block clearfix"> <span
                                                    class="block input-icon input-icon-right"> <input
                                                        ...
                                                        placeholder="输入用户名"/> <i class="ace-icon fa fa-user"></i>
												</span>
                                            </label> <label class="block clearfix"> <span
                                                    class="block input-icon input-icon-right"> <input
                                                        id="password" name="password" type="password"
                                                        class="form-control" placeholder="输入密码"/> <i
                                                        class="ace-icon fa fa-lock"></i>
												</span>
                                            </label> <label class="block clearfix"> <span
                                                    class="block input-icon input-icon-right"> <input id="yzm"
                                                                                                      name="yzm"
                                                                                                      type="text"
                                                                                                      class="form-control"
                                                                                                      placeholder="输入验证码"/> <i
                                                        class="ace-icon fa fa-qrcode"></i>
												</span>
                                            </label> <label class="block clearfix"> <img id="yzm_img"
                                                                                         class="yzm-img"
                                                                                         src="<?php echo $GLOBALS['webroot'] . '/view/common/yzm?' . time() ?>"/>
                                            </label>
                                            <div class="space"></div>
                                            <?php if ($errmsg != "") { ?>
                                                <label class="block clearfix"> <span class="block red"><i
                                                            class="ace-icon fa fa-times-circle"></i> <?php echo $errmsg; ?></span>
                                                </label>
                                                <div class="space"></div>
                                            <?php } ?>
                                            <div class="clearfix">
                                                <label class="inline"> <input type="checkbox"
                                                                              id="RememberInfo" name="RememberInfo"
                                                        <?php if ($RememberInfo == 'on') echo 'checked'; ?>
                                                                              class="ace acp-checkbox-1"/> <span
                                                        class="lbl"> 记住我的信息</span>
                                                </label>
...
<script type="text/javascript" defer async="async"
        ...
        src="../../script/login/login.js<?php echo '?v=1.0.0'; ?>"></script>
</body>
</html>