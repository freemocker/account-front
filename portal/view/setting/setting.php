...
$app = service\tools\ToolsClass::getApplicationInfo(portal\config\PortalConfig::getInstance()['webroot']);
$result = array();
if ($user != null) {
    $userid = $user->getId();
    $appid = $app->getId();
...
<form method="post" class="form-horizontal" id="settings_form"
      action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'] . '?_dialogid=' . $_GET['_dialogid']) ?>">
...
<script type="text/javascript" defer async="async"
        ...
        src="<?php echo $GLOBALS['webroot'] . '/script/setting/setting.js?v=1.0.0'; ?>"></script>
</body>
</html>