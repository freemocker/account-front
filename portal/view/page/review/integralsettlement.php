    ...
    <div class="row">
        <div class="col-xs-12">
            <div
                ...
                <form id="integralSettlementReview_conditionform">
                    <div class="form-group">
                        <label class="col-sm-1 control-label no-padding-right" style="width:100px"
                               for="integralSettlementReview_query_orderno">结算订单号：</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control"
                                   id="integralSettlementReview_query_orderno"
                                   maxlength="24"/>
                        </div>
                        <label class="col-sm-1 control-label no-padding-right" style="width:100px"
                               for="integralSettlementReview_query_businessid">B户客户号：</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control"
                                   id="integralSettlementReview_query_businessid"
                                   maxlength="27"/>
                        </div>
                    </div>
                </form>
            ...
            <div class="col-xs-12 well no-margin-bottom" style="padding: 5px;">
                <div class="div-grid-button-area-b">
                    <button type="button" class="btn btn-xs btn-primary"
                            id="integralSettlementReview_reset_btn">重置查询条件
                    </button>
                    <button type="button" class="btn btn-xs btn-primary"
                            id="integralSettlementReview_query_btn">
                        <i class="ace-icon fa fa-search bigger-120"></i> 查询
                    </button>
                </div>
            </div>
            <div class="col-xs-12 no-padding">
                <table id="integralSettlementReview_grid_table"></table>
                <div id="integralSettlementReview_grid_pager"></div>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" defer async="async"
        ...
        src="<?php echo $GLOBALS['webroot'] . '/script/page/review/integralsettlement.js?v=1.0.0'; ?>"></script>
</body>
</html>