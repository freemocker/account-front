...
<head>
    ...
    $integralSettlementOrder = $commonTools->getDatasBySQL("select ob.orderno,ob.businessid,ob.businessname as bname,ob.amont,ob.actamont,ob.createdate,ob.channel,ob.description,
        ob.accountdate,b.businessname,bb.name,obi.bbindtype,obi.buyerbankname,obi.buyername,obi.buyeraccount,obi.remark 
        from acc_order_base ob 
        inner join acc_order_integralsettlement obi on ob.orderno=obi.orderno 
        inner join acc_business_account b on b.channel=ob.channel 
        inner join acc_dic_b_bindtype bb on obi.bbindtype=bb.code 
        where ob.orderno='" . $_GET['orderno'] . "'");
    ?>
</head>
<body class="<?php echo $GLOBALS['body_class']; ?>">
<div class="page-content no-padding-top">
    <?php if (count($integralSettlementOrder) == 0) { ?>
        ...
        <div class="col-sm-8 col-sm-offset-2" style="padding-top: 20px;">
                ...
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                        <span class="editable-click infocontent">
                            <?php echo $integralSettlementOrder['orderno']; ?></span>
                    </div>
                </div>
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                        <span class="editable-click infocontent">
                            <?php echo $integralSettlementOrder['businessid']; ?></span>
                    </div>
                </div>
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                        <span class="editable-click infocontent">
                            <?php echo $integralSettlementOrder['bname']; ?></span>
                    </div>
                </div>
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                    <span class="editable-click infocontent">
                            <?php echo $integralSettlementOrder['channel']; ?></span>
                    </div>
                </div>
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                    <span class="editable-click infocontent">
                            <?php echo $integralSettlementOrder['businessname']; ?></span>
                    </div>
                </div>
                <div class="infotable-row">
                    <div class="infotable-cell title">结算积分</div>
                    <div class="infotable-cell info">
                    <span class="editable-click infocontent red">
                            <?php echo $integralSettlementOrder['amont']; ?></span>
                    </div>
                </div>
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                    <span class="editable-click infocontent red">
                            <?php echo $integralSettlementOrder['actamont']; ?></span>
                    </div>
                </div>
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                    <span class="editable-click infocontent">
                            <?php echo $integralSettlementOrder['accountdate']; ?></span>
                    </div>
                </div>
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                    <span class="editable-click infocontent">
                            <?php echo $integralSettlementOrder['createdate']; ?></span>
                    </div>
                </div>
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                    <span class="editable-click infocontent">
                            <?php echo $integralSettlementOrder['description']; ?></span>
                    </div>
                </div>
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                    <span class="editable-click infocontent">
                            <?php echo $integralSettlementOrder['remark']; ?></span>
                    </div>
                </div>
            </div>
            <div class="infotable">
                ...
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                        <span class="editable-click infocontent blue">
                            <?php echo $integralSettlementOrder['name']; ?></span>
                    </div>
                </div>
                <?php
                if ($integralSettlementOrder['name'] == 'BANKCARD') { ?>
                    <div class="infotable-row">
                        <div class="infotable-cell title">开户行</div>
                        <div class="infotable-cell info">
                        <span class="editable-click infocontent red">
                            <?php echo $integralSettlementOrder['buyerbankname']; ?></span>
                        </div>
                    </div>
                <?php } ?>
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                        <span class="editable-click infocontent red">
                            <?php echo $integralSettlementOrder['buyername']; ?></span>
                    </div>
                </div>
                <div class="infotable-row">
                    ...
                    <div class="infotable-cell info">
                        <span class="editable-click infocontent red">
                            <?php echo $integralSettlementOrder['buyeraccount']; ?></span>
                    </div>
                </div>
            </div>
            <?php
            ...
            <form class="form-horizontal">
                ...
                <div class="form-actions center no-margin">
                    ...
                    &nbsp;&nbsp;
                    <?php
                    if (service\user\UserManagerClass::validatePermissions($GLOBALS['application']->getId(), $user->getId(), 'back_business_IntegralSettlement')
                        && service\user\UserManagerClass::validatePermissions($GLOBALS['application']->getId(), $user->getId(), 'back_business_cancleIntegralSettlement')
                    ) {
                        ?>
...
<script type="text/javascript" defer async="async"
        ...
        src="<?php echo $GLOBALS['webroot'] . '/script/page/review/integralsettlementInfo.js?v=1.0.0'; ?>"></script>
</body>
</html>