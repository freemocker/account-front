    ...
    <div class="row">
        <div class="col-xs-12">
            <div
                ...
                <form id="dic_sysparam_conditionform">
                    <div class="form-group">
                        <label class="col-sm-1 control-label no-padding-right"
                               for="dic_sysparam_query_name">参数编码：</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control" maxlength="40"
                                   id="dic_sysparam_query_name"
                                   name="dic_sysparam_query_name"/>
                        </div>
                        <label class="col-sm-1 control-label no-padding-right"
                               for="dic_sysparam_query_code">参数值：</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control" maxlength="40"
                                   id="dic_sysparam_query_code"
                                   name="dic_sysparam_query_code"/>
                        </div>
                        <label class="col-sm-1 control-label no-padding-right"
                               for="dic_sysparam_query_status">状态：</label>
                        <div class="col-sm-2">
                            <select class="form-control"
                                    id="dic_sysparam_query_status"
                                    name="dic_sysparam_query_status">
                                <option value=""></option>
            ...
            <div class="col-xs-12 well no-margin-bottom" style="padding: 5px;">
                <div class="div-grid-button-area-b">
                    <button type="button" class="btn btn-xs btn-primary"
                            id="dic_sysparam_reset_btn">重置查询条件
                    </button>
                    <button type="button" class="btn btn-xs btn-primary"
                            id="dic_sysparam_query_btn">
                        <i class="ace-icon fa fa-search bigger-120"></i> 查询
                    </button>
                </div>
            </div>
            <div class="col-xs-12 no-padding">
                <table id="dic_sysparam_grid_table"></table>
                <div id="dic_sysparam_grid_pager"></div>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" defer async="async"
        ...
        src="<?php echo $GLOBALS['webroot'] . '/script/page/dictionary/sysparam.js?v=1.0.0'; ?>"></script>
</body>
</html>