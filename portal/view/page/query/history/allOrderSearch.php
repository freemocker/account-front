    ...
    <div class="row">
        <div class="col-xs-12">
            <div
                ...
                <form id="his_allOrderSearch_conditionform">
                    <div class="form-group">
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="his_allOrderSearch_query_orderno">订单号</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control"
                                   id="his_allOrderSearch_query_orderno"
                                   maxlength="24"/>
                        </div>
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="his_allOrderSearch_query_channel">渠道号</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control"
                                   id="his_allOrderSearch_query_channel"
                                   maxlength="15"/>
                        </div>
                        <label class="col-sm-1 control-label no-padding-right conditionLable-small"
                               for="his_allOrderSearch_query_status">状态</label>
                        <div class="col-sm-2">
                            <select class="form-control" id="his_allOrderSearch_query_status">
                                <option value=""></option>
                                <?php
                    ...
                    <div class="form-group">
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="his_allOrderSearch_query_custid">客户号</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control"
                                   id="his_allOrderSearch_query_custid"
                                   maxlength="27"/>
                        </div>
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="his_allOrderSearch_query_businesstradeno">交易号</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control"
                                   id="his_allOrderSearch_query_businesstradeno"
                                   maxlength="40"/>
                        </div>
                        <label class="col-sm-1 control-label no-padding-right conditionLable-small"
                               for="his_allOrderSearch_query_type">类型</label>
                        <div class="col-sm-2">
                            <select class="form-control" id="his_allOrderSearch_query_type">
                                <option value=""></option>
                                <?php
                    ...
                    <div class="form-group">
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="his_allOrderSearch_query_date_start">下单时间</label>
                        <div class="col-sm-5">
                            <div class="input-daterange input-group">
                                <input type="text" class="form-control" id="his_allOrderSearch_query_date_start"
                                       value="<?php echo \service\tools\ToolsClass::getNowDay(); ?>"/>
                                <span class="input-group-addon"><i class="fa fa-exchange"></i></span>
                                <input type="text" class="form-control" id="his_allOrderSearch_query_date_end"
                                       value="<?php echo \service\tools\ToolsClass::getNowDay(); ?>"/>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xs-12 well no-margin-bottom" style="padding: 5px;">
                <div class="div-grid-button-area-b">
                    <button type="button" class="btn btn-xs btn-primary"
                            id="his_allOrderSearch_reset_btn">重置查询条件
                    </button>
                    <button type="button" class="btn btn-xs btn-primary"
                            id="his_allOrderSearch_query_btn">
                        <i class="ace-icon fa fa-search bigger-120"></i> 查询
                    </button>
                </div>
            </div>
            <div class="col-xs-12 no-padding">
                <table id="his_allOrderSearch_grid_table"></table>
                <div id="his_allOrderSearch_grid_pager"></div>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" defer async="async"
        ...
        src="<?php echo $GLOBALS['webroot'] . '/script/page/query/history/allOrderSearch.js?v=1.0.0'; ?>"></script>
</body>
</html>