    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="form-horizontal col-xs-12 well no-margin-bottom no-padding-bottom">
                <form id="customeryear_conditionform">
                    <div class="form-group">
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="customeryear_query_custid">C客户号</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control"
                                   id="customeryear_query_custid"
                                   maxlength="27"/>
                        </div>
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="customeryear_query_custsubaccountcode">子账户号</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control"
                                   id="customeryear_query_custsubaccountcode"
                                   maxlength="32"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="customeryear_query_type">账户类型</label>
                        <div class="col-sm-3">
                            <select class="form-control" id="customeryear_query_type">
                                <option value=""></option>
                                <?php
                        ...
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="customeryear_query_date_start">统计年</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="customeryear_query_date_start"
            ...
            <div class="col-xs-12 well no-margin-bottom" style="padding: 5px;">
                <div class="div-grid-button-area-b">
                    <button type="button" class="btn btn-xs btn-primary"
                            id="customeryear_reset_btn">重置查询条件
                    </button>
                    <button type="button" class="btn btn-xs btn-primary"
                            id="customeryear_query_btn">
                        <i class="ace-icon fa fa-search bigger-120"></i> 查询
                    </button>
                </div>
            </div>
            <div class="col-xs-12 no-padding">
                <table id="customeryear_grid_table"></table>
                <div id="customeryear_grid_pager"></div>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" defer async="async"
        ...
        src="<?php echo $GLOBALS['webroot'] . '/script/page/query/customer/customeryear.js?v=1.0.0'; ?>"></script>
</body>
</html>