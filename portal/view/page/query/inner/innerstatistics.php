    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="form-horizontal col-xs-12 well no-margin-bottom no-padding-bottom">
                <form id="innerstatistics_conditionform">
                    <div class="form-group">
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="innerstatistics_query_businessid">B客户号</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control"
                                   id="innerstatistics_query_businessid"
                                   maxlength="27"/>
                        </div>
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="innerstatistics_query_innerid">内部账号</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control"
                                   id="innerstatistics_query_innerid"
                                   maxlength="25"/>
                        </div>
                        <label class="col-sm-1 control-label no-padding-right conditionLable"
                               for="innerstatistics_query_accountdate">会计日期</label>
                        <div class="col-sm-2">
                            <div class="input-group">
                                <input type="text" class="form-control"
                                       id="innerstatistics_query_accountdate"
            ...
            <div class="col-xs-12 well no-margin-bottom" style="padding: 5px;">
                <div class="div-grid-button-area-b">
                    <button type="button" class="btn btn-xs btn-primary"
                            id="innerstatistics_reset_btn">重置查询条件
                    </button>
                    <button type="button" class="btn btn-xs btn-primary"
                            id="innerstatistics_query_btn">
                        <i class="ace-icon fa fa-search bigger-120"></i> 查询
                    </button>
                </div>
            </div>
            <div class="col-xs-12 no-padding">
                <table id="innerstatistics_grid_table"></table>
                <div id="innerstatistics_grid_pager"></div>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" defer async="async"
        ...
        src="<?php echo $GLOBALS['webroot'] . '/script/page/query/inner/innerstatistics.js?v=1.0.0'; ?>"></script>
</body>
</html>