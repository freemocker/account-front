...
<head>
    ...
    $orderInfo = $commonTools->getDatasBySQL("select o.*,ot.name as ordertypename,ot.field1 as tablename,st.name as statusname,ba.businessname as businesschannelname
        from acc_order_base o inner join acc_dic_ordertype ot on o.ordertype=ot.code inner join acc_dic_orderstatus st on st.code=o.status inner join acc_business_account ba on ba.channel=o.channel
...
<div class="page-content no-padding-top">
    ...
    <?php } else {
        ...
        <div class="col-sm-8 col-sm-offset-2" style="padding-top: 20px;">
            <input type="hidden" id="orderSearch_orderinfo_orderno"
            ...
            $reviewRecords = $commonTools->getDatasBySQL("select * from acc_order_reviewrecord where orderno='" . $orderno . "' order by reviewdate desc");
...
<script type="text/javascript" defer async="async"
        ...
        src="<?php echo $GLOBALS['webroot'] . '/script/page/query/order/orderinfo.js?v=1.0.0'; ?>"></script>
</body>
</html>