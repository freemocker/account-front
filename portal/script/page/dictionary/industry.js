...
(function ($) {
    ...
    var tablename = "acc_dic_industry";
    var grid_selectorId = "dic_industry_grid_table";
    var pager_selectorId = "dic_industry_grid_pager";
     ...
     */
    dic_industry.generateGrid = function (grid_selectorId, pager_selectorId) {
        ...
        var param = {
            ...
            postData: {
                search_name: function () {
                    return $("#dic_industry_query_name").val();
                },
                search_code: function () {
                    return $("#dic_industry_query_code").val();
                },
                search_status: function () {
                    return $("#dic_industry_query_status").val();
                },
                search_parent: function () {
                    return $("#dic_industry_query_parent").val();
                }
            },
            multiselect: true,
            height: 290,
     ...
     * 绑定事件
     */
    dic_industry.initEvent = function () {
        $("#dic_industry_reset_btn").click(function () {
            $("#dic_industry_conditionform")[0].reset();
        });
        $("#dic_industry_query_btn").click(function () {
            AUI.grid.refreshGrid(grid_selectorId, true);
        });
        $("#dic_industry_add_btn").click(function () {
            AUI.grid.addRecordInline(grid_selectorId);
        });
        $("#dic_industry_del_btn").click(function () {
            AUI.grid.delRecord(grid_selectorId);
        });
    };

    $(function () {
        dic_industry.generateGrid(grid_selectorId, pager_selectorId);
        dic_industry.initEvent();
    });
})($);