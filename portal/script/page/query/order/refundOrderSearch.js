/**
 * Created by zhangbin on 2016/10/16.
 */
(function ($) {

    var grid_selectorId = "refundOrderSearch_grid_table";
    var pager_selectorId = "refundOrderSearch_grid_pager";
     ...
     */
    refundOrderSearch.generateGrid = function (grid_selectorId, pager_selectorId) {
        ...
        var param = {
            ...
            postData: {
                ...
                search_orderno: function () {
                    return $("#refundOrderSearch_query_orderno").val();
                },
                search_channel: function () {
                    return $("#refundOrderSearch_query_channel").val();
                },
                search_status: function () {
                    return $("#refundOrderSearch_query_status").val();
                },
                search_custid: function () {
                    return $("#refundOrderSearch_query_custid").val();
                },
                search_businesstradeno: function () {
                    return $("#refundOrderSearch_query_businesstradeno").val();
                },
                search_type: function () {
                    return $("#refundOrderSearch_query_type").val();
                },
                search_start: function () {
                    return $("#refundOrderSearch_query_date_start").val();
                },
                search_end: function () {
                    return $("#refundOrderSearch_query_date_end").val();
                }
            },
            height: 290,
            sortname: "createdate",
            ...
            colModel: [
                {
                    ...
                    formatter: function (cellvalue, options, rowObject) {
                        return "<div style=\"margin-left:8px;\">"
                            ...
                            + "onclick=\"refundOrderSearch.viewRecord('"
                            + rowObject.orderno
                            + "');\" "
     ...
     * 绑定事件
     */
    refundOrderSearch.initEvent = function () {
        AUI.element.initDatePicker("refundOrderSearch_query_date_start");
        AUI.element.initDatePicker("refundOrderSearch_query_date_end");
        $("#refundOrderSearch_reset_btn").click(function () {
            $("#refundOrderSearch_conditionform")[0].reset();
        });
        $("#refundOrderSearch_query_btn").click(function () {
            if ($("#refundOrderSearch_query_date_start").val() == "") {
                AUI.dialog.alert("请输入时间范围！", null, 3);
                return;
            }
            if ($("#refundOrderSearch_query_date_end").val() == "") {
                AUI.dialog.alert("请输入时间范围！", null, 3);
                return;
            }
     ...
     * 审核
     */
    refundOrderSearch.viewRecord = function (orderno) {
    ...
    $(function () {
        refundOrderSearch.generateGrid(grid_selectorId, pager_selectorId);
        refundOrderSearch.initEvent();
    });
})($);
