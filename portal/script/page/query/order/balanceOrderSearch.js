...
(function ($) {
    ...
    var grid_selectorId = "balanceOrderSearch_grid_table";
    var pager_selectorId = "balanceOrderSearch_grid_pager";
     ...
     */
    balanceOrderSearch.generateGrid = function (grid_selectorId, pager_selectorId) {
        ...
        var param = {
            ...
            postData: {
                ...
                search_orderno: function () {
                    return $("#balanceOrderSearch_query_orderno").val();
                },
                search_channel: function () {
                    return $("#balanceOrderSearch_query_channel").val();
                },
                search_status: function () {
                    return $("#balanceOrderSearch_query_status").val();
                },
                search_custid: function () {
                    return $("#balanceOrderSearch_query_custid").val();
                },
                search_businesstradeno: function () {
                    return $("#balanceOrderSearch_query_businesstradeno").val();
                },
                search_type: function () {
                    return $("#balanceOrderSearch_query_type").val();
                },
                search_start: function () {
                    return $("#balanceOrderSearch_query_date_start").val();
                },
                search_end: function () {
                    return $("#balanceOrderSearch_query_date_end").val();
                }
            },
            height: 290,
            sortname: "createdate",
            ...
            colModel: [
                {
                    ...
                    formatter: function (cellvalue, options, rowObject) {
                        return "<div style=\"margin-left:8px;\">"
                            ...
                            + "onclick=\"balanceOrderSearch.viewRecord('"
                            + rowObject.orderno
                            + "');\" "
     ...
     * 绑定事件
     */
    balanceOrderSearch.initEvent = function () {
        AUI.element.initDatePicker("balanceOrderSearch_query_date_start");
        AUI.element.initDatePicker("balanceOrderSearch_query_date_end");
        $("#balanceOrderSearch_reset_btn").click(function () {
            $("#balanceOrderSearch_conditionform")[0].reset();
        });
        $("#balanceOrderSearch_query_btn").click(function () {
            if ($("#balanceOrderSearch_query_date_start").val() == "") {
                AUI.dialog.alert("请输入时间范围！", null, 3);
                return;
            }
            if ($("#balanceOrderSearch_query_date_end").val() == "") {
                AUI.dialog.alert("请输入时间范围！", null, 3);
                return;
            }
     ...
     * 审核
     */
    balanceOrderSearch.viewRecord = function (orderno) {
    ...
    $(function () {
        balanceOrderSearch.generateGrid(grid_selectorId, pager_selectorId);
        balanceOrderSearch.initEvent();
    });
})($);
