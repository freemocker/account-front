...
(function ($) {
    ...
    var grid_selectorId = "integralOrderSearch_grid_table";
    var pager_selectorId = "integralOrderSearch_grid_pager";
     ...
     */
    integralOrderSearch.generateGrid = function (grid_selectorId, pager_selectorId) {
        ...
        var param = {
            ...
            postData: {
                ...
                search_orderno: function () {
                    return $("#integralOrderSearch_query_orderno").val();
                },
                search_channel: function () {
                    return $("#integralOrderSearch_query_channel").val();
                },
                search_status: function () {
                    return $("#integralOrderSearch_query_status").val();
                },
                search_custid: function () {
                    return $("#integralOrderSearch_query_custid").val();
                },
                search_businesstradeno: function () {
                    return $("#integralOrderSearch_query_businesstradeno").val();
                },
                search_type: function () {
                    return $("#integralOrderSearch_query_type").val();
                },
                search_start: function () {
                    return $("#integralOrderSearch_query_date_start").val();
                },
                search_end: function () {
                    return $("#integralOrderSearch_query_date_end").val();
                }
            },
            height: 290,
            sortname: "createdate",
            ...
            colModel: [
                {
                    ...
                    formatter: function (cellvalue, options, rowObject) {
                        return "<div style=\"margin-left:8px;\">"
                            ...
                            + "onclick=\"integralOrderSearch.viewRecord('"
                            + rowObject.orderno
                            + "');\" "
     ...
     * 绑定事件
     */
    integralOrderSearch.initEvent = function () {
        AUI.element.initDatePicker("integralOrderSearch_query_date_start");
        AUI.element.initDatePicker("integralOrderSearch_query_date_end");
        $("#integralOrderSearch_reset_btn").click(function () {
            $("#integralOrderSearch_conditionform")[0].reset();
        });
        $("#integralOrderSearch_query_btn").click(function () {
            if ($("#integralOrderSearch_query_date_start").val() == "") {
                AUI.dialog.alert("请输入时间范围！", null, 3);
                return;
            }
            if ($("#integralOrderSearch_query_date_end").val() == "") {
                AUI.dialog.alert("请输入时间范围！", null, 3);
                return;
            }
     ...
     * 审核
     */
    integralOrderSearch.viewRecord = function (orderno) {
    ...
    $(function () {
        integralOrderSearch.generateGrid(grid_selectorId, pager_selectorId);
        integralOrderSearch.initEvent();
    });
})($);
