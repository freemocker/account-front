...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $table = '';
    $tablenames = $commonTools->getDatasBySQL("select code from acc_batch_histables where parentid='acc_inner_summary' and code >= 'acc_inner_summary_$year' order by code desc");
